import { It as onMounted, Mt as onBeforeUnmount, W as computed, _n as watch, er as toRefs, mt as h$1, qn as ref, rt as defineComponent } from "./vue.runtime.esm-bundler-BoiyDnld.js";
...
var s = typeof window < `u` && window.document !== void 0, c = new Uint8Array([
	...
	`w`,
	`h`
], u = `0.71.0`, d = `@lottiefiles/dotlottie-web`;
var f;
...
var j = class {
	...
	get_layer_bounds(e) {
		let t = x(e, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n = v;
		return f.dotlottieplayerwasm_get_layer_bounds(this.__wbg_ptr, t, n);
	}
	get_pixel_buffer() {
	...
	seek(e) {
		return f.dotlottieplayerwasm_seek(this.__wbg_ptr, e) !== 0;
	}
	stop() {
	...
	intersect(e, t, n) {
		let r = x(n, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), i = v;
		return f.dotlottieplayerwasm_intersect(this.__wbg_ptr, e, t, r, i) !== 0;
	}
	is_loaded() {
...
var J = q(F, `https://cdn.jsdelivr.net/npm/${d}@${u}/dist/dotlottie-player.wasm`, `https://unpkg.com/${d}@${u}/dist/dotlottie-player.wasm`), Y = (e) => {
	switch (e) {
...
var ae = class {
	...
	_drainSmEvents() {
		...
		for (; (t = this._dotLottieCore.sm_poll_internal_event()) != null;) {
			...
			if (e.type === `Message`) {
				let t = e.message ?? ``;
				s && t.startsWith(`OpenUrl: `) ? K(t) : this._eventManager.dispatch({
	...
	_loadFromData(e) {
		...
		r ? (this._renderConfig.quality !== void 0 && this._dotLottieCore.set_quality(this._renderConfig.quality), s && this.resize(), this._drainPlayerEvents(), this._marker && this._dotLottieCore.set_marker(this._marker), setTimeout(() => {
			this._eventManager.dispatch({
				type: `frame`,
	...
	play() {
		...
		this._drainPlayerEvents(), (e || this._dotLottieCore.is_playing()) && (this._isFrozen = !1, this._startAnimationLoop()), this._canvas && s && this._canvas instanceof HTMLCanvasElement && this._renderConfig.freezeOnOffscreen && !W(this._canvas) && this.freeze();
	}
	pause() {
	...
	getWorker(e) {
		return this._workers.has(e) || this._workers.set(e, new oe()), this._workers.get(e);
	}
...
var $ = class e {
	constructor(t) {
		...
		this._pendingConfig = i, this._canvas && (this._create(i), this._pendingConfig = null), this._worker.addEventListener(`message`, this._handleWorkerEvent.bind(this));
	}
	...
	async destroy() {
		this._created && (this._created = !1, await this._sendMessage(`destroy`, { instanceId: this._id }), this._cleanupStateMachineListeners(), e._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), s && this._canvas instanceof HTMLCanvasElement && (L.unobserve(this._canvas), R.unobserve(this._canvas)));
	}
	async freeze() {
